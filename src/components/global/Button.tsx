...
export const ButtonBlack: React.FC<button> = ({children, type, className, halaman_url, onClick}) => {
...
export const ButtonBlackBorder: React.FC<button> = ({children, type, className, halaman_url, onClick}) => {
