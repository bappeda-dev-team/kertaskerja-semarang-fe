...
const data = [
    {
        "id": 1,
        "strategic_opd": "MENINGKATNYA PROFESIONALITAS ASN",
        "pemilik": "akun test level 3",
        "nip" : "1280471847",
        "sasaran_opd" : "contoh sasaran opd 1",
        "tujuan_opd": "Terwujudnya profesionalitas ASN",
                ...
                <table className="w-full">
                    <thead>
                        <tr className="text-xm bg-emerald-500 text-white">
                            ...
                            <td rowSpan={2} className="border-r border-b px-6 py-3 min-w-[300px]">Strategic OPD</td>
                            <td rowSpan={2} className="border-r border-b px-6 py-3 min-w-[300px]">Pemilik</td>
